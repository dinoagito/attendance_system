...
<!-- Statistics Cards - Employee/Faculty and Visitors only (Student removed) -->
<div class="row mb-4">
    <div class="col-md-4 col-sm-6 mb-3">
        <div class="stat-card green">
            ...
            <div class="stat-card-label">Employees / Faculty</div>
        </div>
    </div>
    <div class="col-md-4 col-sm-6 mb-3">
...
<div class="row">
    <!-- Attendance Chart - Employees only -->
    <div class="col-lg-8 mb-4">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-chart-bar"></i> Weekly Employee Attendance Overview
            </div>
            <div class="card-body">
    ...
    <!-- Attendance Summary - Employees only -->
...
<!-- Recent Attendance - Employees only -->
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-history"></i> Recent Employee Attendance Records
            </div>
            <div class="card-body">
